...
__host__ \
void PARACUDA_##NAME##_run(PARACUDA_##TYPE##_struct* array, int* flags, int* flags_copy, size_t length, size_t max_threads) \
{\
  /*PARACUDA_##NAME##_upsweep(array, flags_copy, length, max_threads);*/ \
    /* PARACUDA_##NAME##_downsweep(array, flags_copy, flags, length, max_threads);*/ \
